class csv():
    ...
    def __str__(self):
        ...
        for i in range(len(self.data)):
            ...
            for j in range(1,len(self.data[0])):
                text += "{0:8.2f}".format(self.data[i][j]) + ' '
            text += '\n'
...
2. I've noted that we would need to clean the data for this csv file. (Eg. commas, empty values) 
Perhaps we could incorporate some code to automate the data cleaning process.
"""